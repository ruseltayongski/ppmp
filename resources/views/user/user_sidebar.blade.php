<div class="col-md-3">
    ...
    <div class="box box-primary">
        <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" src="{{ str_replace('ppmpv2','pis',asset('')).'public/upload_picture/picture/'.$information->picture }}" onerror="this.onerror=null;this.src='{{ str_replace('ppmp','pis',asset('')).'public/upload_picture/picture/uknown.png' }}' " alt="User profile picture">
